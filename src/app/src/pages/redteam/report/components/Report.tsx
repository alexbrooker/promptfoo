...
const App: React.FC = () => {
  ...
  return (
    <Container maxWidth="xl">
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="caption" sx={{ color: '#666' }}>
                Powered by <a href="https://airsidelabs.com/" target="_blank" rel="noopener" style={{ color: '#1976d2', textDecoration: 'none' }}>Airside Labs</a> - AI Testing & Security Evaluation
              </Typography>
            </Box>
          </Box>
      ...
      {/* Airside Labs Footer */}
      <Card sx={{ mt: 4, p: 3, backgroundColor: '#f8f9fa', borderTop: '3px solid #1976d2' }}>
        <Box sx={{ textAlign: 'center' }}>
          <Typography variant="body2" sx={{ color: '#666', mb: 1 }}>
            Report generated by <strong>Airside Labs</strong> - Professional AI Testing & Security Evaluation
          </Typography>
          ...
          <Box sx={{ mt: 2, display: 'flex', justifyContent: 'center', gap: 3 }}>
            ...
            <a 
              href="https://airsidelabs.com/privacy/" 
              target="_blank" 
              rel="noopener" 
              style={{ color: '#1976d2', textDecoration: 'none', fontSize: '0.875rem' }}
            >
